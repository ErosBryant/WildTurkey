...
virtual void CompactOrderdRange(const Slice* begin, const Slice* end, int max_level = 1);
...
private:
  ...
  struct CompactionStats {
    CompactionStats() : micros(0),max_micros(0), bytes_read(0), bytes_written(0), compaction_count(0),max_bytes_read(0), max_bytes_written(0) {}
  ...
  int CompactMemTable() EXCLUSIVE_LOCKS_REQUIRED(mutex_);
